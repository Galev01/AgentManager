...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/reviews/inbox", label: "Review Inbox", icon: "M3 7l9 6 9-6M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/tools", label: "Tools & Skills", icon: "M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" },
      { href: "/config", label: "Config", icon: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" },
  ...
  },
  {
    label: "Brain",
    items: [
      { href: "/brain/people", label: "People", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
    ],
  },
  {
    label: "Advanced",
    items: [
      { href: "/capabilities", label: "Capabilities", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
  ...
  return (
    <aside className="fixed left-0 top-0 z-10 flex h-full w-[var(--sidebar-width)] flex-col border-r border-dark-border bg-dark-card">
      <div className="flex h-[var(--header-height)] items-center px-6">
        <span className="text-xl font-semibold tracking-tight text-primary">OpenClaw</span>
      </div>
      ...
      <div className="border-t border-dark-border px-6 py-4">
        <p className="text-xs text-text-muted">OpenClaw Manager</p>
      </div>
    </aside>
  );
}
